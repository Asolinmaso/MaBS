...
const CallToAction = () => {
  return (
    <div className=" bg-gradient-to-t from-[#19BDE880]/50 to-white py-16 text-center mb-20 mt-25">
  <h2 className="text-2xl font-semibold mb-4">Ready to Elevate Your Carrer?</h2>
