    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 auto-rows-[200px] grid-flow-dense">
        {newsData.map((news, index) => {
          ...
          // Custom layout based on Figma screenshot structure
          ...
          else if (index === 6) span = "md:col-span-1 md:row-span-1";
...
const NewsCard = ({ image, description, link }) => {
  return (
    <div className="relative overflow-hidden  shadow-lg group cursor-pointer h-full">
      ...
      />
      <div className="absolute inset-0 backdrop-blur-md bg-white/30 opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col justify-end p-4 text-black">
