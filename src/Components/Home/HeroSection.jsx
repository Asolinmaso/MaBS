    ...
    return (
        <>
            <header className="relative w-full h-screen overflow-hidden flex items-center justify-center">
                ...
                <div className="relative z-20 flex flex-col items-center justify-center gap-4 text-center text-white max-w-[936px] px-4">
                    ...
                    >
                        <CustomBtn className="mt-6 border-2 rounded-lg px-6 py-3 border-[#19BDE8] text-[#19BDE8] font-medium text-lg sm:text-xl md:text-2xl hover:border-white hover:text-white focus:scale-90 cursor-pointer transition duration-200 ease-in-out">
                            Booking Appointment
                        </CustomBtn>
                    </a>
                </div>
