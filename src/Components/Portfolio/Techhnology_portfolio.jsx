    ...
    <>
      ...
      <main className='mb-15'>
        ...
        <section className='max-w-6xl mt-10 mx-auto px-4 md:px-6 lg:px-8 py-10'>
          ...
          <h2 className='font-medium text-xl md:text-3xl mb-6'>Website Design</h2>
          <img
            src={one}
            alt="Website Design"
          ...
          <div className="w-full max-w-[1200px] mx-auto mt-10">
            <div className="flex flex-col md:flex-row md:justify-between md:gap-16 gap-6">
              <div className="flex flex-col ">
                <h3 className="text-xl md:text-3xl font-medium mb-4">Client</h3>
                <p className='text-base md:text-lg text-gray-700'>Shimmr Studios</p>
              </div>
              <div className="flex flex-col ">
                <h3 className="text-xl md:text-3xl font-medium mb-4">What they do</h3>
              ...
              <div className="flex flex-col ">
                <h3 className="text-xl md:text-3xl font-medium mb-4">Project overview</h3>
        ...
        <section className='max-w-6xl mt-10 mx-auto p-6 rounded-md'>
          <h2 className='font-medium  text-xl md:text-2xl mt-8 sm:mt-15 mb-5'>E-commerce Platform</h2>
          <img src={two} alt="E-commerce Platform" className="w-full rounded-lg" />
          <div className="w-full max-w-[1200px] mx-auto mt-10">
            <div className="flex flex-col md:flex-row md:justify-between md:gap-16 gap-6">
              <div className="flex flex-col ">
                <h3 className="text-xl md:text-3xl font-medium mb-4">Client</h3>
                <p className= 'text-base md:text-lg text-gray-700'>Motiff Bespoke</p>
              </div>
              <div className="flex flex-col ">
                <h3 className="text-xl md:text-3xl font-medium mb-4">What they do</h3>
                <p className='md:text-lg text-base text-gray-700 leading-relaxed'>
        ...
        <section className='max-w-6xl mt-10 mx-auto p-6 rounded-md'>
          ...
          <div className="w-full max-w-[1200px] mx-auto mt-10">
            <div className="flex flex-col md:flex-row md:justify-around md:gap-16 gap-6">
              <div className="flex flex-col ">
                <h3 className="text-xl md:text-3xl font-medium mb-4">Client</h3>
                <p className=' md:text-lg text-base text-gray-700'>KISEM</p>
              </div>
              <div className="flex flex-col ">
                <h3 className="text-xl md:text-3xl font-medium mb-4">What they do</h3>
                <p className='md:text-lg text-base text-gray-700 leading-relaxed'>
