        ...
        <footer className="bg-[#1E1E1E] text-white py-10 px-5 md:px-20">
            <div className="max-w-screen-xl mx-auto grid md:grid-cols-2 gap-10">
                ...
                <div className="w-full h-full flex justify-center items-center">
                    <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3343.787121350818!2d80.10354060984038!3d13.158248010706805!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5263fb8806579d%3A0x5403d896b56b2a06!2sVellanur%20Branch%20Post%20Office!5e1!3m2!1sen!2sin!4v1745922764023!5m2!1sen!2sin" 
                        width="100%"
                        height="290"
                        style={{ border: 0 }}
                        allowFullScreen=""
