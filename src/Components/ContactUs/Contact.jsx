...
const Contact = () => {
    ...
    return (
        <>
            <header className='flex flex-col w-full min-h-[822.86px] justify-center items-center relative pt-30 sm:pt-0'>
                <img className='absolute w-full h-full z-0 object-cover' src={bg} alt="" />
                <div className='absolute top-0 left-0 w-full h-full bg-black/70 z-10'></div>
                <div className='flex flex-col items-center gap-6 text-center w-full max-w-6xl h-[96] z-20 text-white px-4'>
                    <h1 className='text-[#19BDE8] font-semibold text-4xl md:text-6xl'>Contact Us</h1>
                    <p className='font-normal text-xl md:text-2xl'>We’d love to hear from you! Whether you have a question, need assistance, or want to explore how we can work together, our team is here to help.</p>
                    <a href="https://outlook.office365.com/book/Catherine1@deepdarkcreations.com/" target='_blank'>
                        <CustomBtn className='mt-4 border-2 rounded-lg p-4 border-[#19BDE8] text-[#19BDE8] font-medium text-lg md:text-2xl hover:border-white focus:scale-90 hover:text-white cursor-pointer'>
                            Booking Appointment
                        </CustomBtn>
                    </a>
                </div>
                <div className='z-20 flex flex-wrap gap-6 justify-center items-center w-full max-w-6xl pt-5'>
                    <div className='rounded-2xl p-6 flex flex-col gap-6 bg-white/10 w-full sm:w-[280px] h-[188px] text-white items-center text-center'>
                        < HiOutlineLocationMarker className='h-16 w-16 text-[#19BDE8]' />
                        <div>
                    ...
                    <div className='rounded-2xl p-6 flex flex-col gap-6 bg-white/10 w-full sm:w-[280px] h-[188px] text-white items-center text-center'>
                        ...
                        <div>
                            <p className='font-normal text-xl'>E-Mail Us</p>
                            <p className='font-normal text-xl'>admin@manvian.com</p>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <section className="max-w-3xl mx-auto px-4 pt-20">
                <h2 className="text-center text-2xl font-semibold text-[#19BDE8] mb-8">
                ...
                <div className="space-y-4">
                    {faqs.map((faq, index) => (
                        ...
                        >
                            ...
                            <div
                                className={`px-5 pb-4 text-gray-600 text-sm transition-all duration-300 ${activeIndex === index ? 'block' : 'hidden'
                                    }`}
                            >
                                {faq.answer}
                            </div>
            ...
            <div className='w-full bg-white py-12 flex flex-col items-center'>
                ...
                <div className='text-center max-w-2xl p-5'>
                    <h2 className='text-3xl md:text-4xl font-bold text-[#19BDE8] mb-3'>Still Have Questions?</h2>
                    <p className='text-gray-600 text-base md:text-lg'>
                        Didn't find your answer above? We're here to help. Just fill out the form below and we’ll get back to you soon.
                    </p>
                </div>
                <form action="" className='bg-white shadow-2xl rounded-xl px-10 flex flex-col gap-6 w-full max-w-4xl mx-auto mt-15 mb-20 pb-10'>
                    ...
                    <div className='text-right'>
                        <button className='bg-[#19BDE8] text-white font-medium py-3 px-6 rounded-lg'>
                            Send Message
                        </button>
                    </div>
                </form>
